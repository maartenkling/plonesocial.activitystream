...
class ConversationProvider(object):
    ...
    def __init__(self, context, request, view):
        ...
        self.users = None
        self.thread_id = request.form.get('thread_id', None)
    ...
    def activities(self):
        status = [self._activities_status()]
        ...
        items = itertools.chain(status, statuses)
    ...
    def _activities_status(self):
        ...
        try:
            ...
            return container.get(int(self.thread_id))
        except Unauthorized:
            return []
    ...
    def _activities_statuses(self):
        ...
        try:
            # default implementation
            return container.thread_values(limit=self.count,
                                           tag=self.tag,
